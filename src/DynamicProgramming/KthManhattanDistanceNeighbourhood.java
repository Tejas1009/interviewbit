...
public class KthManhattanDistanceNeighbourhood {
    ...
    public int[][] solve(int k, int[][] A) {
        int n = A.length, m = A[0].length, min = Integer.MIN_VALUE;
        int[][] res = deepCopy(A);
        for (int x = 0; x < k; x++) {
            for (int i = 0; i < n; i++) {
                for (int j = 0; j < m; j++) {
    ...
    public int[][] solve2(int A, int[][] B) {
        int n = B.length, m = B[0].length, min = Integer.MIN_VALUE;
    ...
    public static void main(String[] args) {
        KthManhattanDistanceNeighbourhood k = new KthManhattanDistanceNeighbourhood();
        //int a[][] = {{1, 2, 4}, {4, 5, 8}};
        int a[][] = {
